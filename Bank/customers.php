...
<meta name="keywords" content="the sparks foundation internship certificate, donation, the sparks foundation internship, grip at the sparks foundation, grip at the sparks foundation internship, the sparks foundation grip, the sparks foundation github, the sparks foundation internship web development, the sparks foundation internship, the sparks foundation linkedin, the sparks foundation network, the sparks foundation singapore, the sparks foundation tasks, the sparks foundation web development internship, bank , bank at grip, grip, bank grip, Graduate Rotational Internship Program, Payment gateway integration, task Payment gateway integration">
...
<title>Customer | Bank of Buissiness</title>
<style>
body {
margin:0;
padding:0;
...
<section class="page-header">
    <div class="header">
        <div class="header-left"> 
            <img src="images/4.jpg" class="header-left-logo">
        </div>    
...
<section class="page-footer">
    <footer class="footer-distributed">
        <div class="footer-left">
            <h2>Bank of <span>Buissiness</span></h2>
